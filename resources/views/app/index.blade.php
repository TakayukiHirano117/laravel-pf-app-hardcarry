            ...
            @foreach ($posts as $post)
                <div class="max-w-3xl px-8 py-4 bg-white rounded-lg shadow-md dark:bg-gray-800 mt-6 mb-6 ml-10 hover:bg-gray-100 duration-300 cursor-pointer">
                    <div class="flex items-center justify-between">
                        ...
                        <div x-data="{ isOpen: false, showDeleteModal: false }" class="relative inline-block">
                            ...
                            >
                                ...
                                <a href="#" class="block px-4 py-3 font-bold text-red-500 capitalize transition-colors duration-300 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white" @click.prevent="showDeleteModal = true"> Delete </a>
                                
                                <a href="{{ route('app.post.edit', $post) }}" class="block px-4 py-3 text-sm text-gray-600 capitalize transition-colors duration-300 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white"> Edit </a>
                    ...
                    <div class="flex items-center justify-between mt-4">
                        ...
                        <div class="flex items-center hover:bg-gray-200 duration-300 rounded-lg py-2 pr-4">
