...
<body>
    <div class="flex">
        ...
        {{-- 削除 --}}
        <form action="{{ route('app.post.destroy', $post) }}" method="post" class="ml-10 w-full">
          <h1 class="text-4xl mt-5">Delete Post</h1>
          ...
          @method('delete')
            <div class="w-1/6">
                ...
                <input type="date" id="deadline" name="deadline" value="{{ old('deadline', $post->deadline) }}" class="block  mt-2 w-full placeholder-gray-400/70 dark:placeholder-gray-500 rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300" disabled/>
            </div>
            ...
            <div class="mt-5">
              <button class="px-6 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-red-600 rounded-lg hover:bg-red-700 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80 flex items-center">
